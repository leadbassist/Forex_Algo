...
# identify the candle for potential hanging man
...
def set_candle_patterns(df_an: pd.DataFrame):
    ...
    df_an["MORNING_STAR"] = df_an.apply(apply_morning_star, axis=1, direction=1)
